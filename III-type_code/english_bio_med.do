...
//************ 英文和第二外語 ************//
use "lang_adv_electives_bio_med.dta", clear
...
save "english_bio_med.dta", replace

use "all_stdnt_nb_III.dta", clear
merge 1:m sch_ep5 using "english_bio_med.dta" //213 obs
drop _merge
...
keep sch_ep5 id_nat_ncnu_ep5 bio_med_stdnt_nb full lang_elect_cr snd_for_lang_cr_stdnt eng_adv_elect_cr_stdnt
...
drop id_nat_ncnu_ep5 lang_elect_cr full snd_for_lang_cr_stdnt eng_adv_elect_cr_stdnt

duplicates drop

save "result_III\完整修滿英文加深加廣比例的各校學生人數及占比_0818_bio_med.dta", replace

//************************//
use "english_bio_med.dta", clear
...
save "english_detail_bio_med.dta", replace

use "all_stdnt_nb_III.dta", clear
merge 1:m sch_ep5 using "english_detail_bio_med.dta" //213 obs
drop _merge
...
duplicates drop
save "result_III\engs_sch_0829_bio_med.dta", replace
restore

//僅保留以學生為單位的數據
keep sch_ep5 id_nat_ncnu_ep5 snd_for_lang_stdnt eng_listen_stdnt eng_reading_stdnt eng_essay_stdnt bio_med_stdnt_nb
...
keep sch_ep5 bio_med_stdnt_nb snd_for_lang_enroll_sch
duplicates drop

save "result_III\加深加廣修過二外各校學生人數_0901_bio_med.dta", replace
restore
...
tab eng_adv_elect snd_for_lang_stdnt if not_pass == 0 & too_much == 0
...
keep sch_ep5 bio_med_stdnt_nb not_pass_sch too_much_sch six_eng_sch four_eng_two_s_sch two_eng_four_s_sch
duplicates drop

save "result_III\英文加深加廣組合各校學生人數及占比_0901_bio_med.dta", replace