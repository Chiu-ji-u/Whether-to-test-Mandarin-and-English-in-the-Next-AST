...
//************ 英文和第二外語 ************//
use "lang_adv_electives_sci_eng.dta", clear
...
save "english_sci_eng.dta", replace

use "all_stdnt_nb_III.dta", clear
merge 1:m sch_ep5 using "english_sci_eng.dta" //213 obs
drop _merge
...
keep sch_ep5 id_nat_ncnu_ep5 sci_eng_stdnt_nb full lang_elect_cr snd_for_lang_cr_stdnt eng_adv_elect_cr_stdnt
...
save "result_III\完整修滿英文加深加廣比例的各校學生人數及占比_0818_sci_eng.dta", replace

//************************//
use "english_sci_eng.dta", clear
...
save "english_detail_sci_eng.dta", replace

use "all_stdnt_nb_III.dta", clear
merge 1:m sch_ep5 using "english_detail_sci_eng.dta" //213 obs
drop _merge
...
duplicates drop
save "result_III\engs_sch_0829_sci_eng.dta", replace
restore

//僅保留以學生為單位的數據
keep sch_ep5 id_nat_ncnu_ep5 snd_for_lang_stdnt eng_listen_stdnt eng_reading_stdnt eng_essay_stdnt sci_eng_stdnt_nb
...
keep sch_ep5 sci_eng_stdnt_nb snd_for_lang_enroll_sch
duplicates drop

save "result_III\加深加廣修過二外各校學生人數_0901_sci_eng.dta", replace
restore
...
keep sch_ep5 sci_eng_stdnt_nb not_pass_sch too_much_sch six_eng_sch four_eng_two_s_sch two_eng_four_s_sch
duplicates drop

save "result_III\英文加深加廣組合各校學生人數及占比_0901_sci_eng.dta", replace