...
save "lang_adv_electives_bio_med.dta", replace
...
save "mandarin_bio_med.dta", replace

//******* 學校國文總開課數分布 *******//
keep sch_ep5 zh_know_sch_nb zh_exp_sch_nb zh_lit_sch_nb zh_topic_sch_nb
duplicates drop

save "result_III\學校國文總開課數分布(學分數)_0829_bio_med.dta", replace

use "all_stdnt_nb_III.dta", clear
merge 1:1 sch using "result_III\學校國文總開課數分布(學分數)_0829_bio_med.dta"
...
drop _merge
drop sci_eng_stdnt_nb soc_stdnt_nb both_stdnt_nb none_stdnt_nb stdnt_nb
save "result_III\學校國文總開課數分布(學分數)_0829_bio_med.dta", replace

//******* 各校國文修過人數分布 *******//
use "all_stdnt_nb_III.dta", clear
merge 1:m sch_ep5 using "mandarin_bio_med.dta"
drop _merge

keep sch_ep5 bio_med_stdnt_nb id_nat_ncnu_ep5 zh_know_stdnt_cr zh_exp_stdnt_cr zh_lit_stdnt_cr zh_topic_stdnt_cr

duplicates drop sch_ep5 bio_med_stdnt_nb id_nat_ncnu_ep5 zh_know_stdnt_cr zh_exp_stdnt_cr zh_lit_stdnt_cr zh_topic_stdnt_cr, force
...
save "result_III\各校國文修過人數分布_0829_bio_med.dta", replace
...
keep sch_ep5 id_nat_ncnu_ep5 bio_med_stdnt_nb pass
...
save "result_III\至少修超過四學分國文加深加廣的各校學生人數及占比_0829_bio_med.dta", replace
restore

//calculate average credit of Mandarin
keep sch_ep5 id_nat_ncnu_ep5 bio_med_stdnt_nb zh_elect_cr
...
save "result_III\國文加深加廣各校學生平均修課學分數_0829_bio_med.dta", replace
