...
//************ 英文和第二外語 ************//
use "lang_adv_electives.dta", clear
...
save "english.dta", replace

use "all_stdnt_nb.dta", clear
merge 1:m sch_ep5 using "english.dta" //3 obs
drop _merge
...
keep sch_ep5 id_nat_ncnu_ep5 stdnt_nb full lang_elect_cr snd_for_lang_cr_stdnt eng_adv_elect_cr_stdnt
...
save "result_2\完整修滿英文加深加廣比例的各校學生人數及占比_0902_pre.dta", replace
...
save "english_detail.dta", replace

use "all_stdnt_nb.dta", clear
merge 1:m sch_ep5 using "english_detail.dta" //3 obs
drop _merge
...
duplicates drop
save "result_2\engs_sch_0902_pre.dta", replace
restore

//僅保留以學生為單位的數據
keep sch_ep5 id_nat_ncnu_ep5 snd_for_lang_stdnt eng_listen_stdnt eng_reading_stdnt eng_essay_stdnt stdnt_nb
...
keep sch_ep5 stdnt_nb snd_for_lang_enroll_sch

duplicates drop 

save "result_2\加深加廣修過二外各校學生人數_0902_pre.dta", replace
restore
...
keep sch_ep5 stdnt_nb not_pass_sch too_much_sch six_eng_sch four_eng_two_s_sch two_eng_four_s_sch 

duplicates drop

save "result_2\英文加深加廣組合各校學生人數及占比_0902_pre.dta", replace