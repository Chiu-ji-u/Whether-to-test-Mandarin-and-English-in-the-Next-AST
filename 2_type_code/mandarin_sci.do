...
save "lang_adv_electives_sci.dta", replace
...
save "result_2\學校國文總開課數分布(學分數)_0902_pre_sci.dta", replace

use "all_stdnt_nb.dta", clear
merge 1:1 sch using "result_2\學校國文總開課數分布(學分數)_0902_pre_sci.dta"
...
//******* 各校國文修過人數分布 *******//
use "all_stdnt_nb.dta", clear
merge 1:m sch_ep5 using "mandarin_sci.dta"
drop _merge

keep sch_ep5 sci_stdnt_nb id_nat_ncnu_ep5 zh_know_stdnt_cr zh_exp_stdnt_cr zh_lit_stdnt_cr zh_topic_stdnt_cr

duplicates drop sch_ep5 sci_stdnt_nb id_nat_ncnu_ep5 zh_know_stdnt_cr zh_exp_stdnt_cr zh_lit_stdnt_cr zh_topic_stdnt_cr, force
...
save "result_2\各校國文修過人數分布_0902_pre_sci.dta", replace
...
keep sch_ep5 id_nat_ncnu_ep5 sci_stdnt_nb pass
...
save "result_2\至少修超過四學分國文加深加廣的各校學生人數及占比_0902_pre_sci.dta", replace
restore

//calculate average credit of Mandarin
keep sch_ep5 id_nat_ncnu_ep5 sci_stdnt_nb zh_elect_cr
...
save "result_2\國文加深加廣各校學生平均修課學分數_0902_pre_sci.dta", replace
